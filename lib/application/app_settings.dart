...
class AppSettings {
  ...
  static const _KEY_ADB_EXECUTABLE = "adbExecutable";
  ...
  AppSettings(SharedPrefs prefs)
    : adbExecutable = prefs.getString(prefix: _PREFIX, key: _KEY_ADB_EXECUTABLE),
      ...
      isLastUsedProfileDefault = prefs.getBool(
        prefix: _PREFIX,
        key: _KEY_IS_LAST_USED_PROFILE_DEFAULT,
        defaultValue: true,
      ),
      defaultProfileId = prefs.getInt(prefix: _PREFIX, key: _KEY_DEFAULT_PROFILE_ID);

  final Preference<String> adbExecutable;
